...
<head>
    ...
    <link rel="shortcut icon" href="assets\img\Logo Y.png" type="image/x-icon">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets\img\Logo Y.png" width="150">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; <a target="_blank" rel="noopener noreferrer">MikeSoftware</a> <?php echo date("Y"); ?></div>
                        <div>
